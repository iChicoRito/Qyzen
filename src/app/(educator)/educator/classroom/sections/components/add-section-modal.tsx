    ...
    <ResponsiveDialog open={open} onOpenChange={handleOpenChange}>
      ...
      <ResponsiveDialogContent showCloseButton={false} className="gap-0 p-0" desktopClassName="sm:max-w-[620px]">
        <ResponsiveDialogHeader className="border-b">
          <ResponsiveDialogTitle>Add New Section</ResponsiveDialogTitle>
          <ResponsiveDialogDescription>Create a classroom section and assign academic terms.</ResponsiveDialogDescription>
        </ResponsiveDialogHeader>
