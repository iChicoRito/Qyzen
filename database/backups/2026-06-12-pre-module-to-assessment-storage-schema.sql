...
-- File: C:/Users/marka/.config/superpowers/worktrees/qyzen/rename-modules-to-assessments/database/backups/2026-06-12-pre-module-to-assessment-storage-schema.sql
-- Created: 2026-06-12
-- Purpose: Live schema backup for storage before module-to-assessment migration.
...
ALTER TABLE ONLY "storage"."buckets" DROP CONSTRAINT IF EXISTS "buckets_pkey";
ALTER TABLE ONLY "storage"."buckets" ADD CONSTRAINT "buckets_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "storage"."buckets_analytics" DROP CONSTRAINT IF EXISTS "buckets_analytics_pkey";
ALTER TABLE ONLY "storage"."buckets_analytics" ADD CONSTRAINT "buckets_analytics_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "storage"."buckets_vectors" DROP CONSTRAINT IF EXISTS "buckets_vectors_pkey";
ALTER TABLE ONLY "storage"."buckets_vectors" ADD CONSTRAINT "buckets_vectors_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "storage"."migrations" DROP CONSTRAINT IF EXISTS "migrations_pkey";
ALTER TABLE ONLY "storage"."migrations" ADD CONSTRAINT "migrations_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "storage"."migrations" DROP CONSTRAINT IF EXISTS "migrations_name_key";
ALTER TABLE ONLY "storage"."migrations" ADD CONSTRAINT "migrations_name_key" UNIQUE (name);
ALTER TABLE ONLY "storage"."objects" DROP CONSTRAINT IF EXISTS "objects_bucketId_fkey";
...
ALTER TABLE ONLY "storage"."objects" DROP CONSTRAINT IF EXISTS "objects_pkey";
ALTER TABLE ONLY "storage"."objects" ADD CONSTRAINT "objects_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "storage"."s3_multipart_uploads" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_bucket_id_fkey";
...
ALTER TABLE ONLY "storage"."s3_multipart_uploads" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_pkey";
ALTER TABLE ONLY "storage"."s3_multipart_uploads" ADD CONSTRAINT "s3_multipart_uploads_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "storage"."s3_multipart_uploads_parts" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_parts_bucket_id_fkey";
...
ALTER TABLE ONLY "storage"."s3_multipart_uploads_parts" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_parts_upload_id_fkey";
...
ALTER TABLE ONLY "storage"."s3_multipart_uploads_parts" DROP CONSTRAINT IF EXISTS "s3_multipart_uploads_parts_pkey";
ALTER TABLE ONLY "storage"."s3_multipart_uploads_parts" ADD CONSTRAINT "s3_multipart_uploads_parts_pkey" PRIMARY KEY (id);
ALTER TABLE ONLY "storage"."vector_indexes" DROP CONSTRAINT IF EXISTS "vector_indexes_bucket_id_fkey";
...
ALTER TABLE ONLY "storage"."vector_indexes" DROP CONSTRAINT IF EXISTS "vector_indexes_pkey";
...
CREATE UNIQUE INDEX IF NOT EXISTS buckets_pkey ON storage.buckets USING btree (id);
CREATE UNIQUE INDEX IF NOT EXISTS buckets_analytics_pkey ON storage.buckets_analytics USING btree (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS buckets_vectors_pkey ON storage.buckets_vectors USING btree (id);
CREATE UNIQUE INDEX IF NOT EXISTS migrations_name_key ON storage.migrations USING btree (name);
CREATE UNIQUE INDEX IF NOT EXISTS migrations_pkey ON storage.migrations USING btree (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS objects_pkey ON storage.objects USING btree (id);
...
CREATE UNIQUE INDEX IF NOT EXISTS s3_multipart_uploads_pkey ON storage.s3_multipart_uploads USING btree (id);
CREATE UNIQUE INDEX IF NOT EXISTS s3_multipart_uploads_parts_pkey ON storage.s3_multipart_uploads_parts USING btree (id);
CREATE UNIQUE INDEX IF NOT EXISTS vector_indexes_name_bucket_id_idx ON storage.vector_indexes USING btree (name, bucket_id);
CREATE UNIQUE INDEX IF NOT EXISTS vector_indexes_pkey ON storage.vector_indexes USING btree (id);
