-- ==================== ADD REVIEW AND HINT FIELDS TO TBL_ASSESSMENTS ====================
-- File: database/sql/migrations/add_allow_review_allow_hint_to_tbl_assessments.sql
-- Created: 2026-03-31
-- Purpose: Add educator review and hint configuration fields to assessment rows
